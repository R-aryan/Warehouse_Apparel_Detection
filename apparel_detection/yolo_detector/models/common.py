...
from apparel_detection.yolo_detector.utils.datasets import letterbox
from apparel_detection.yolo_detector.utils.general import non_max_suppression, make_divisible, \
    scale_coords
